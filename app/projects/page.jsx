  ...
  return (
    <div>
      <div className="bg-[url('/image/backgroundproject.jpg')] bg-center bg-cover">
        <h1 className='container py-64 text-6xl font-bold tracking-widest text-pink-600'>Our Projects</h1>
      </div>
      ...
      <div className='container grid lg:grid-cols-2 gap-8 py-8'>
        {
          projects.map((project) => (
            <div key={project.id} className='relative overflow-hidden rounded-xl group'>
              ...
              <div className='absolute bottom-0 right-0 bg-white/90 dark:bg-black/40 flex-col items-center justify-end w-96 gap-32
              p-12 text-xl transition duration-300 ease-in-out translate-y-full from-transparent to-black group-hover:translate-y-0'>
