        ...
        <div className='pt-12'>
            <div className='mx-auto max-w-7xl px-6 lg:px-8'>
                ...
                className='mx-auto mt-10 grid lg:grid-cols-3 grid-cols-1 gap-x-8 lg:max-w-none lg:mx-0 
                                sm:py-16 sm:mt-16 border-b border-gray-200 border-t gap-y-16'>
                    {
                        posts.map((post) => (
                          <article
                          key={post.id}
                          ...
                          >
                            <div className='flex items-center gap-x-4 text-xs'>
                                ...
                                className='relative z-10 bg-primary rounded-full text-white px-3 py-1.5 font-medium hover:bg-gray-100
                            ...
                            <div className='relative mt-8 flex items-center gap-x-4'>
                                <img src={post.author.imageUrl} alt='' className='h-10 w-10 rounded-full bg-gary-500'/>
