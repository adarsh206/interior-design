  ...
  return (
    <div className='container py-12 xl:py-12 h-[auto] text-center lg:py-0 lg:text-left lg:flex lg:justify-between'>
        ...
        <div className='lg:w-1/2 xl:py-14 lg:py-8'>
            ...
            className='tracking-widest uppercase font-bold'>Offer for the best Interior</motion.p>
            <motion.h1 
            initial="offscreen"
            whileInView={"onscreen"}
            variants={desVariants}
            className='h1 text-pink-600'>Make your home a <br />piece of art</motion.h1>
        <motion.p 
        initial="offscreen"
        whileInView={"onscreen"}
